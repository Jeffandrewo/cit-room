...
function Floor7({ roomsData, searchQuery, searchBy  }) {
...
const F7 = ({ searchQuery, searchBy }) => {
  ...
  return (
    <div>
      <Floor7 roomsData={info} searchQuery={searchQuery} searchBy={searchBy} />
    </div>
  );
};
