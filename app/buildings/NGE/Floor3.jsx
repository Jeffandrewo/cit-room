...
function Floor3({ roomsData, searchQuery, searchBy }) {
...
const F3 = ({ searchQuery, searchBy }) => {
  ...
  return (
    <div>
      <Floor3 roomsData={info} searchQuery={searchQuery} searchBy={searchBy} />
    </div>
  );
};
