...
function Floor6({ roomsData, searchQuery, searchBy  }) {
...
const F6 = ({ searchQuery, searchBy }) => {
  ...
  return (
    <div>
      <Floor6 roomsData={info} searchQuery={searchQuery} searchBy={searchBy} />
    </div>
  );
};
